...
class QuestionType(models.Model):
    question_type_id = models.BigAutoField(primary_key=True,null=False,unique=True)
    question_type = models.CharField(max_length=100,null=False)
    
class Company(models.Model):
    company_id = models.BigAutoField(primary_key=True,null=False,unique=True)
    company = models.CharField(max_length=100,null=False)
    logo_url = models.CharField(max_length=500)
class MajorLarge(models.Model):
    major_large_id = models.BigAutoField(primary_key=True,null=False,unique=True)
    major_large = models.CharField(max_length=100,null=False)
    
class MajorSmall(models.Model):
    major_small_id = models.BigAutoField(primary_key=True,null=False,unique=True)
...
class JobLarge(models.Model):
    job_large_id = models.BigAutoField(primary_key=True,null=False,unique=True)
    job_large = models.CharField(max_length=100,null=False)
    
class JobSmall(models.Model):
    job_small_id = models.BigAutoField(primary_key=True,null=False,unique=True)
...
class RecommendType(models.Model):
    rectype_id = models.BigAutoField(primary_key=True,null=False,unique=True)
